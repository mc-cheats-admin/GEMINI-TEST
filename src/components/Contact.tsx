    ...
    <section id="контакты" className="py-32 relative z-10" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-16 max-w-6xl mx-auto">
          ...
          {/* Form */}
          <div className={`w-full lg:w-2/3 premium-glass p-8 md:p-12 rounded-3xl transition-all duration-1000 delay-300 ${hasIntersected ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
            <form onSubmit={handleSubmit}>
              ...
              <div className="input-group mb-8 relative mt-8">
                <select 
                  id="subject" 
                  className="interactive w-full bg-transparent border-b border-white/30 text-white py-3 outline-none focus:border-[var(--color-neon-blue)] transition-colors appearance-none cursor-pointer"
              ...
              <div className={`input-group mt-8 mb-12 ${errors.message ? 'shake' : ''}`}>
                <textarea 
                  id="message" 
                  rows={4} 
                  required 
              ...
              <button 
                ...
                className={`interactive relative overflow-hidden flex items-center justify-center font-display font-bold tracking-widest uppercase transition-all duration-500 ${
            ...
            <div className="space-y-10">
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  ...
                  <a href="mailto:hello@universe.digital" className="interactive text-xl font-sans text-white hover:text-[var(--color-neon-blue)] transition-colors">hello@universe.digital</a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="interactive text-xl font-sans text-white hover:text-[var(--color-neon-pink)] transition-colors">+1 (234) 567-890</a>
                </div>
              </div>
              ...
              <div className="flex space-x-4">
                {['TW', 'IN', 'GH', 'DB'].map((social, i) => (
                  <a 
                    key={social} 
                    href="#" 
                    className="interactive w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center font-display font-bold text-white hover:bg-white hover:text-black hover:-translate-y-2 hover:shadow-[0_10px_20px_rgba(255,255,255,0.2)] transition-all duration-300"
